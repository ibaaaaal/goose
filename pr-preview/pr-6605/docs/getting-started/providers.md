...
| [Claude Code ACP](https://github.com/zed-industries/claude-code-acp) (`claude-code-acp`) | Uses Claude Code over the ACP protocol. Provides native tool permission handling and MCP server passthrough.                                                                                               | `@zed-industries/claude-code-acp` npm package installed                                                                                              |
| [Codex ACP](https://developers.openai.com/codex/cli) (`codex-acp`)         | Uses OpenAI Codex over the ACP protocol. Provides native tool permission handling and MCP server passthrough.                                                                                                | `@zed-industries/codex-acp` npm package installed                                                                                                     |
